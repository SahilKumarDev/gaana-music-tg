<h1 align="center">🎵 Gaana Music Bot 🎵</h1>
...
## 🚀 Deploy on Heroku 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/CyberPixelPro/GaanaMusic)
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/SahilKumarDev/gaana-music && cd gaana-music
   ```
...
The Gaana Music Bot offers a range of commands to enhance your music listening experience on Telegram:
...
For a full list of commands, use `/help` in [telegram](https://t.me/GaanaBeatzBot).

---

### 🔄 Updates & Support

Stay updated with the latest features and improvements to Gaana Music Bot:
...
We welcome contributions to the Gaana Music Bot project. If you'd like to contribute, please follow these steps:
...
Thanks to all the contributors, supporters, and users of the Gaana Music Bot. Your feedback and support keep us going!
