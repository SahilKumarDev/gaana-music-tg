...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SahilKumarDev/gaana-music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "http://RichMusicUpdates.t.me")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "http://RichMusictalks.t.me")
