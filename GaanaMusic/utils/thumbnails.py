...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("GaanaMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("GaanaMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("GaanaMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("GaanaMusic/assets/play_icons.png")
